...
public class Main extends Application {
    ...
    public void prepararMenuInicio() throws Exception{
        ...
        jugar.setPrefSize(250,90);
        jugar.setStyle("-fx-font: 40 arial; -fx-base: #000000; -fx-border-color: #6d1fd8; -fx-text-fill: #f04ef5");
    ...
    public void buttonCrearUsuarios () throws Exception{
        ...
        ingresar.setLayoutX(400);
        ingresar.setLayoutY(500);
